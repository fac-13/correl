...
const postSymptomRating = (symptom, username, rating) => dbConnect.query('insert into symptom_data (symptom_id, user_id, rating) values((select id from symptoms where symptom = $1 and user_id=(select id from users where username=$2)), (select id from users where username=$2),$3)', [symptom, username, rating]);
// post factor ratings
